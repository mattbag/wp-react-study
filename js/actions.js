...
export function fetchProjects() {
	return ( dispatch, getStore ) => {
		Api.get( '/wp/v2/projects', { _embed: true, per_page: 100 }, ( data, error ) => {
...
// 	return ( dispatch, getStore ) => {
// 		Api.get( '/wp/v2/projects/' + id, { _embed: true }, ( data, error ) => {
//
// 			if ( ! data || error ) {
// 				return;
// 			}
...
export function fetchProject( slug ) {
	return ( dispatch, getStore ) => {
		Api.get( '/wp/v2/projects', { filter: { name: slug } }, ( data, error ) => {
			if ( ! data || error ) {
				return;
			}
			dispatch({
