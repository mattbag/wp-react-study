...
import Post from './components/pages/PostSingle'
...
const routes = (
	<ReduxRouter>
		<Route path="/" component={AppWithReduxConnected}>
			...
			<Route path="projects" component={connect(state=>state)(Projects)} />
			<Route path="project/:slug" component={connect(state=>state)(Project)} />
